...
export default function ManagerPropertyDetailPage({ params }: { params: { id: string } }) {
  ...
  if (property === undefined) return <p className="font-mono text-[11px] text-ink-faint">Loading…</p>;
  if (property === null) return <p className="font-mono text-[11px] text-rust">Property not found.</p>;
  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <div className="ledger-panel p-6">
        <h2 className="mb-4 font-display text-lg font-semibold text-ink">Maintenance history</h2>
